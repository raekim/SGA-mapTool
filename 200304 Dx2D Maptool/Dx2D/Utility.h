...
inline float GetAngleAsRadian(D3DXVECTOR2 p1, D3DXVECTOR2 p2) // p1 -> p2
{
	/*
...
inline float GetAngleAsDegree(D3DXVECTOR2 p1, D3DXVECTOR2 p2) // p1 -> p2
{
	return D3DXToDegree(GetAngleAsRadian(p1, p2));
}
